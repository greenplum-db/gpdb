...
def icg():
    ...
    return subprocess.call([
        ...
        make installcheck-optfunctional\""], cwd="gpdb_src", shell=True)

def copy_output():
    shutil.copyfile("gpdb_src/src/test/regress/optfunctional/regression.diffs", "icg_output/regression.diffs")
    shutil.copyfile("gpdb_src/src/test/regress/optfunctional/regression.out", "icg_output/regression.out")
