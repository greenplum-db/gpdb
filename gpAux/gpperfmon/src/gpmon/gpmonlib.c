...
#define QENODE_TYPE_RESILIENT_JOIN "Hash Join"
#define QENODE_TYPE_RESILIENT_LEFT_JOIN "Hash Left Join"
#define QENODE_TYPE_RESILIENT_LEFT_ANTI_SEMI_JOIN "Hash Left Anti Semi Join"
#define QENODE_TYPE_RESILIENT_FULL_JOIN "Hash Full Join"
#define QENODE_TYPE_RESILIENT_RIGHT_JOIN "Hash Right Join"
#define QENODE_TYPE_RESILIENT_EXISTS_JOIN "Hash EXISTS Join"
#define QENODE_TYPE_RESILIENT_REVERSE_IN_JOIN "Hash Reverse In Join"
#define QENODE_TYPE_RESILIENT_UNIQUE_INNER_JOIN "Hash Unique Inner Join"
#define QENODE_TYPE_RESILIENT_UNIQUE_OUTER_JOIN "Hash Unique Outer Join"
...
#define QENODE_MEASURE_RESILIENT_JOIN_SPILL_BATCHES "Resilient Join Spill Batches"
#define QENODE_MEASURE_RESILIENT_JOIN_SPILL_TUPLES "Resilient Join Spill Tuples"
#define QENODE_MEASURE_RESILIENT_JOIN_SPILL_BYTES "Resilient Join Spill Bytes"
...
#define QENODE_RESILIENTJOIN_METRICS \
		{QENODE_MEASURE_ROWS_IN, QENODE_MEASURE_RESILIENT_JOIN_SPILL_BATCHES, QENODE_MEASURE_RESILIENT_JOIN_SPILL_TUPLES, QENODE_MEASURE_RESILIENT_JOIN_SPILL_BYTES}
#define QENODE_RESILIENTJOIN_UNITS \
		{QENODE_UNIT_ROWS, QENODE_UNIT_BATCHES, QENODE_UNIT_TUPLES, QENODE_UNIT_BYTES}
...
QenodeNamesDescriptor nodetype_string_lookup[PMNT_MAXIMUM_ENUM] =
{
	...
	{PMNT_ResilientJoin, QENODE_TYPE_RESILIENT_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientLeftJoin, QENODE_TYPE_RESILIENT_LEFT_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientLeftAntiSemiJoin, QENODE_TYPE_RESILIENT_LEFT_ANTI_SEMI_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientFullJoin, QENODE_TYPE_RESILIENT_FULL_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientRightJoin, QENODE_TYPE_RESILIENT_RIGHT_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientExistsJoin, QENODE_TYPE_RESILIENT_EXISTS_JOIN,
		QENODE_RESILIENTJOIN_METRICS,
		QENODE_RESILIENTJOIN_UNITS,
		1
	},
	{PMNT_ResilientReverseInJoin, QENODE_TYPE_RESILIENT_REVERSE_IN_JOIN,
		{QENODE_MEASURE_ROWS_IN },
		{QENODE_UNIT_ROWS },
		1
	},
	{PMNT_ResilientUniqueOuterJoin, QENODE_TYPE_RESILIENT_UNIQUE_OUTER_JOIN,
		{QENODE_MEASURE_ROWS_IN },
		{QENODE_UNIT_ROWS },
		1
	},
	{PMNT_ResilientUniqueInnerJoin, QENODE_TYPE_RESILIENT_UNIQUE_INNER_JOIN,
		{QENODE_MEASURE_ROWS_IN },
		{QENODE_UNIT_ROWS },
		1
	},
