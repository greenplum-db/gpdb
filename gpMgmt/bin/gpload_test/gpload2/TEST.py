...
def write_config_file(config='config/config_file',mode='insert', reuse_flag='',columns_flag='0',mapping='0',portNum='8081',database='reuse_gptest',
host='localhost',formatOpts='text',file='data/external_file_01.txt',table='texttable',format='text',delimiter="'|'",
escape='',quote='',header=None,truncate='False',log_errors=None, error_limit='0',error_table=None,externalSchema=None,update_columns='n2',
staging_table=None,fast_match='false', encoding=None, preload=True, SQL=False, sql_before=None, sql_after=None, columns=None,match_columns='true'):
    ...
    f.write("\n    - UPDATE_COLUMNS:")
    f.write("\n           - "+update_columns)
    if match_columns and match_columns=='true':
        f.write("\n    - MATCH_COLUMNS:")
        f.write("\n           - n1")
        f.write("\n           - s1")
        f.write("\n           - s2")
    if match_columns and match_columns=='2':
        f.write("\n    - MATCH_COLUMNS:")
        f.write("\n           - '\"Field1\"'")
        f.write("\n           - '\"Field#2\"'")
    if mapping=='1':
