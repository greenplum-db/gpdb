...
typedef enum {
	...
	GREENPLUM_CONTINUE_CHECK_ON_ERROR = 8,
...
#define GREENPLUM_OPTIONS \
  ...
  {"continue-check-on-error", no_argument, NULL, GREENPLUM_CONTINUE_CHECK_ON_ERROR}, \
...
#define GREENPLUM_USAGE "\
      ...
      --continue-check-on-error goes through all pg_upgrade checks, without upgrade\n\
...
bool is_continue_check_on_error(void);
