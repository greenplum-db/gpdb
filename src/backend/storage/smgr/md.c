...
mdunlink(RelFileNodeBackend rnode, ForkNumber forkNum, bool isRedo, char relstorage)
{
	 ...
	 *
	 * On the primary, when fowarding of fsync requests is enabled for AO, we
	 * must also be able to forget them.  On the mirror, AO fsync requests are
	 * always forwarded.
	 */
...
_mdfd_getseg(SMgrRelation reln, ForkNumber forknum, BlockNumber blkno,
			 bool skipFsync, bool is_appendoptimized, ExtensionBehavior behavior)
{
