 ...
 * Notes:
 * (1) We use zstd compression as our base. zlib is twice as expensive as seen
 * during profiling and in literature.
 ...
 * instead of estimating (once we make it available in the optimizer).
 */
