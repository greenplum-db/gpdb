								 ...
								 Plan *subplan)
{
	 ...
	 * in the parent slice. It might be zero if the plan is
	 * generated by orca, in this case, we use the number of
	 * segments in the parent slice as the module number of
	 * the cdb hash.
	 */
	int			numHashSegments;
