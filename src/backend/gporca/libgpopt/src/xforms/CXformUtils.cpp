...
//	    	1. Picks Forward if ORDER BY columns and index keys sort and nulls
//	    	directions are equal.
//	    	2. Picks Backward if ORDER BY columns and index keys sort and nulls
//	    	directions are commutative.
//---------------------------------------------------------------------------
EIndexScanDirection
