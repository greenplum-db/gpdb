...
location ('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/nation.tbl' )
FORMAT 'text' (delimiter '|');

CREATE EXTERNAL TABLE EXT_REGION  (LIKE REG_REGION)
location ('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/region.tbl' )
FORMAT 'text' (delimiter '|');
...
CREATE EXTERNAL TABLE EXT_HDFS_READ  ( N_NATIONKEY  INTEGER ,
                            ...
                            N_REGIONKEY  INTEGER ,
                            N_COMMENT    VARCHAR(152))
location ('gphdfs://localhost@:123/Data/nation.tbl' )
FORMAT 'text' (delimiter '|');
...
CREATE WRITABLE EXTERNAL TABLE EXT_HDFS_WRITE  ( N_NATIONKEY  INTEGER ,
                            ...
                            N_REGIONKEY  INTEGER ,
                            N_COMMENT    VARCHAR(152))
location ('gphdfs://localhost@/data/nation.tbl' )
FORMAT 'text';
...
execute E'( python /usr/local/pgsql/bin/gppinggpfdist.py localhost:7070 2>&1 || echo) '
on SEGMENT 0
FORMAT 'text' (delimiter '|');

CREATE EXTERNAL WEB TABLE exttab1_gpfdist_start (x text)
execute E'((/usr/local/pgsql/bin/gpfdist -p 7070 -d /Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data  </dev/null >/dev/null 2>&1 &); sleep 2; echo "starting...") '
on SEGMENT 0
FORMAT 'text' (delimiter '|');
...
FORMAT 'text' (delimiter '|');
CREATE EXTERNAL TABLE EXT_REGION  (LIKE REG_REGION)
location ('gpfdist://localhost:7070/region.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('gpfdist://localhost:7070/whois.csv' )
...
location('gpfdist://localhost:7070/missing_fields1.data' )
format 'text' ( delimiter '|' fill missing fields);

create external table ext_fill2(a int, b int, c int)
location('gpfdist://localhost:7070/missing_fields2.data' )
format 'text' ( delimiter '|' fill missing fields);
...
location('gpfdist://localhost:7070/mpp6698.data' )
format 'csv' (quote '''');
...
location('gpfdist://localhost:7070/mpp12839*.data' )
...
location ('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/no/such/place/badt1.tbl' )
format 'text' (delimiter '|');
select * from badt1;
...
location ('bad_protocol://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/no/such/place/badt2.tbl' )
format 'text' (delimiter '|');
...
--
-- positive
create writable external table wet_pos1(a text, b text) location('gpfdist://localhost:7070/wet.out') format 'text';
create writable external table wet_pos2(a text, b text) location('gpfdist://localhost:7070/wet.out') format 'text' distributed by(b);
...
create readable external table ret_region(like wet_region) location('gpfdist://localhost:7070/wet_region.out') format 'text';

-- negative
create writable external table wet_neg1(a text, b text) location('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/badt1.tbl') format 'text';
create writable external table wet_neg1(a text, b text) location('gpfdist://localhost:7070/wet.out', 'gpfdist://localhost:7070/wet.out') format 'text';
...
LOCATION ('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/mpp17980.data')
...
COPY (VALUES('1,2'),('1,2,3'),('1,'),('1')) TO '/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/tableless.csv';
CREATE TABLE tableless_heap(a int, b int);
COPY tableless_heap FROM '/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/tableless.csv' CSV LOG ERRORS SEGMENT REJECT LIMIT 10;
...
location ('file://localhost/Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/tableless.csv')
format 'csv'
...
\! rm /Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/tableless.csv
