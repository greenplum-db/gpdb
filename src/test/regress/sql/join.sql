...
explain select fooJoinPruning.* from fooJoinPruning left join barJoinPruning on (select t1JoinPruning.n from t1JoinPruning)=(select t2JoinPruning.y from t2JoinPruning) where fooJoinPruning.c>100;
explain select fooJoinPruning.* from fooJoinPruning left join barJoinPruning on barJoinPruning.q=100  where fooJoinPruning.c>100;
explain select fooJoinPruning.* from fooJoinPruning left join barJoinPruning on barJoinPruning.p=barJoinPruning.q  where fooJoinPruning.b>300;
drop table fooJoinPruning;
drop table barJoinPruning;
drop table t1JoinPruning;
drop table t2JoinPruning;
...
explain select fooJoinPruning.* from fooJoinPruning left join barJoinPruning on (select t1JoinPruning.n from t1JoinPruning)=(select t2JoinPruning.y from t2JoinPruning) and barJoinPruning.t=100  where fooJoinPruning.b>300;
