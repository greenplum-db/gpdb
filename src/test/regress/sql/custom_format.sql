...
execute E'( python /usr/local/pgsql/bin/gppinggpfdist.py localhost:7575 2>&1 || echo) '
on SEGMENT 0
FORMAT 'text' (delimiter '|');

CREATE EXTERNAL WEB TABLE gpfdist_start (x text)
execute E'((/usr/local/pgsql/bin/gpfdist -p 7575 -d /Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/fixedwidth/  </dev/null >/dev/null 2>&1 &); sleep 2; echo "starting...") '
on SEGMENT 0
FORMAT 'text' (delimiter '|');
...
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_correct.tbl')       
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_fieldtype.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_toomanyfields.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_toofewfields.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_fieldtoolong.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_rejectlimitcrossed.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15')
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_error_rejectlimitnotcrossed.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20',n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15')
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_nulldefined.tbl')       
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_blankfields.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20', n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
SELECT s1 FROM tbl_ext_fixedwidth WHERE s2 IS NULL ORDER BY s1;
SELECT n1 FROM tbl_ext_fixedwidth WHERE n2 IS NULL ORDER BY s1;
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_small_blankfields_and_nulls.tbl')       
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_big.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20', n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
...
EXECUTE E'( rm -f /Users/garrettthornburg/Development/C++Development/gpdb/src/test/regress/data/fixedwidth/fixedwidth_out.tbl)'
on SEGMENT 0
FORMAT 'text';
...
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_out.tbl')     
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_no_line_delimiter.tbl')      
...
CREATE READABLE EXTERNAL TABLE tbl_ext_fixedwidth 
(s1 char(10), s2 varchar(10), s3 text, dt timestamp, n1 smallint, n2 integer, n3 bigint, n4 decimal, n5 numeric, n6 real, n7 double precision)                                                              
LOCATION ('gpfdist://localhost:7575/fixedwidth_3chars_line_delimiter.tbl')       
FORMAT 'CUSTOM' (formatter='fixedwidth_in', s1='10', s2='10', s3='10', dt='20', n1='5', n2='10', n3='10', n4='10', n5='10', n6='10', n7='15', line_delim='@#$');
SELECT * FROM tbl_ext_fixedwidth ORDER BY s1;
