...
select usename as user_for_reindex_heap from gp_stat_operations where objname = 'idx_mytab1_heap' and subtype = 'REINDEX' ;
select usename as user_for_reindex_ao from gp_stat_operations where objname = 'idx_mytab1_ao' and subtype = 'REINDEX' ;
select usename as user_for_reindex_aoco from gp_stat_operations where objname = 'idx_mytab1_aoco' and subtype = 'REINDEX' ;
