...
drop table if exists truncate_without_create_ao;
drop table if exists truncate_with_create_ao;

begin;
create table truncate_with_create_ao(a int, b int) with (appendoptimized = true, orientation = row) distributed by (a);
insert into truncate_with_create_ao select i, i from generate_series(1,1000)i;
...
insert into truncate_without_create_ao select i, i from generate_series(1,1000)i;
...
drop table if exists truncate_without_create_aocs;
drop table if exists truncate_with_create_aocs;

begin;
create table truncate_with_create_aocs(a int, b int) with (appendoptimized = true, orientation = column) distributed by (a);
insert into truncate_with_create_aocs select i, i from generate_series(1,1000)i;
...
insert into truncate_without_create_aocs select i, i from generate_series(1,1000)i;
...
drop table if exists truncate_without_create;
drop table if exists truncate_with_create;

begin;                                                                          
create table truncate_with_create_heap(a int, b int) distributed by (a);
insert into truncate_with_create_heap select i, i from generate_series(1,1000)i;
truncate truncate_with_create_heap;
end;

create table truncate_without_create_heap(a int, b int) distributed by (a);
insert into truncate_without_create_heap select i, i from generate_series(1,1000)i;
