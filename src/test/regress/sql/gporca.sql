...
EXPLAIN SELECT b FROM tt1 WHERE b NOT IN (SELECT d FROM tt2 WHERE (tt2.d = tt1.b) IS DISTINCT FROM false);
SELECT b FROM tt1 WHERE b NOT IN (SELECT d FROM tt2 WHERE (tt2.d = tt1.b) IS DISTINCT FROM false);

EXPLAIN SELECT b FROM tt1 WHERE b NOT IN (SELECT d FROM tt2 WHERE (tt2.d = tt1.b) IS DISTINCT FROM true);
SELECT b FROM tt1 WHERE b NOT IN (SELECT d FROM tt2 WHERE (tt2.d = tt1.b) IS DISTINCT FROM true);
