...
DATA(insert OID = 3426 ( complex_send  PGNSP PGUID 12 1 0 0 f f t f i 1 0 17 f "193" _null_ _null_ _null_ _null_ complex_send _null_ _null_ c ));
DESCR("I/O");

/* complex(float8, float8) => complex */ 
DATA(insert OID = 3427 ( complex  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "701 701" _null_ _null_ _null_ _null_ construct_complex _null_ _null_ c ));
DESCR("constructs a complex number with given real part and imaginary part");

/* complex_trig(float8, float8) => complex */ 
DATA(insert OID = 3428 ( complex_trig  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "701 701" _null_ _null_ _null_ _null_ construct_complex_trig _null_ _null_ c ));
DESCR("constructs a complex number with given magnitude and phase");

/* re(complex) => float8 */ 
DATA(insert OID = 3429 ( re  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_re _null_ _null_ c ));
DESCR("returns the real part of the argument");

/* im(complex) => float8 */ 
DATA(insert OID = 3430 ( im  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_im _null_ _null_ c ));
DESCR("returns the imaginary part of the argument");

/* radians(complex) => float8 */ 
DATA(insert OID = 3431 ( radians  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_arg _null_ _null_ c ));
DESCR("returns the phase of the argument");

/* complexabs(complex) => float8 */ 
DATA(insert OID = 3432 ( complexabs  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_mag _null_ _null_ c ));
DESCR("returns the magnitude of the argument");

/* abs(complex) => float8 */ 
DATA(insert OID = 3433 ( abs  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_mag _null_ _null_ c ));
DESCR("returns the magnitude of the argument");

/* conj(complex) => complex */ 
DATA(insert OID = 3434 ( conj  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_conj _null_ _null_ c ));
DESCR("returns the conjunction of the argument");

/* hashcomplex(complex) => int4 */ 
DATA(insert OID = 3435 ( hashcomplex  PGNSP PGUID 12 1 0 0 f f t f i 1 0 23 f "193" _null_ _null_ _null_ _null_ complex_hash _null_ _null_ c ));
DESCR("hash");

/* complex_eq(complex, complex) => bool */ 
DATA(insert OID = 3436 ( complex_eq  PGNSP PGUID 12 1 0 0 f f t f i 2 0 16 f "193 193" _null_ _null_ _null_ _null_ complex_eq _null_ _null_ c ));
DESCR("equal");

/* complex_ne(complex, complex) => bool */ 
DATA(insert OID = 3437 ( complex_ne  PGNSP PGUID 12 1 0 0 f f t f i 2 0 16 f "193 193" _null_ _null_ _null_ _null_ complex_ne _null_ _null_ c ));
DESCR("not equal");

/* complex_pl(complex, complex) => complex */ 
DATA(insert OID = 3438 ( complex_pl  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_pl _null_ _null_ c ));
DESCR("plus");

/* complex_up(complex) => complex */ 
DATA(insert OID = 3439 ( complex_up  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_up _null_ _null_ c ));
DESCR("unary plus");

/* complex_mi(complex, complex) => complex */ 
DATA(insert OID = 3440 ( complex_mi  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_mi _null_ _null_ c ));
DESCR("minus");

/* complex_um(complex) => complex */ 
DATA(insert OID = 3441 ( complex_um  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_um _null_ _null_ c ));
DESCR("unary minus");

/* complex_mul(complex, complex) => complex */ 
DATA(insert OID = 3442 ( complex_mul  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_mul _null_ _null_ c ));
DESCR("multiply");

/* complex_div(complex, complex) => complex */ 
DATA(insert OID = 3443 ( complex_div  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_div _null_ _null_ c ));
DESCR("divide");

/* complex_power(complex, complex) => complex */ 
DATA(insert OID = 3444 ( complex_power  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_pow _null_ _null_ c ));
DESCR("exponentiation (x^y)");

/* complex_sqrt(complex) => complex */ 
DATA(insert OID = 3445 ( complex_sqrt  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_sqrt _null_ _null_ c ));
DESCR("square root");

/* complex_cbrt(complex) => complex */ 
DATA(insert OID = 3446 ( complex_cbrt  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_cbrt _null_ _null_ c ));
DESCR("cube root");

/* degrees(complex) => float8 */ 
DATA(insert OID = 3447 ( degrees  PGNSP PGUID 12 1 0 0 f f t f i 1 0 701 f "193" _null_ _null_ _null_ _null_ complex_degrees _null_ _null_ c ));
DESCR("phase to degrees");

/* exp(complex) => complex */ 
DATA(insert OID = 3448 ( exp  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_exp _null_ _null_ c ));
DESCR("natural exponential (e^x)");

/* ln(complex) => complex */ 
DATA(insert OID = 3449 ( ln  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_ln _null_ _null_ c ));
DESCR("natural logarithm");

/* log(complex) => complex */ 
DATA(insert OID = 3450 ( log  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_log10 _null_ _null_ c ));
DESCR("base 10 logarithm");

/* log(complex, complex) => complex */ 
DATA(insert OID = 3451 ( log  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_log _null_ _null_ c ));
DESCR("logarithm base arg1 of arg2");

/* acos(complex) => complex */ 
DATA(insert OID = 3452 ( acos  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_acos _null_ _null_ c ));
DESCR("acos");

/* asin(complex) => complex */ 
DATA(insert OID = 3453 ( asin  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_asin _null_ _null_ c ));
DESCR("asin");

/* atan(complex) => complex */ 
DATA(insert OID = 3454 ( atan  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_atan _null_ _null_ c ));
DESCR("atan");

/* cos(complex) => complex */ 
DATA(insert OID = 3455 ( cos  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_cos _null_ _null_ c ));
DESCR("cos");

/* cot(complex) => complex */ 
DATA(insert OID = 3456 ( cot  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_cot _null_ _null_ c ));
DESCR("cot");

/* sin(complex) => complex */ 
DATA(insert OID = 3457 ( sin  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_sin _null_ _null_ c ));
DESCR("sin");

/* tan(complex) => complex */ 
DATA(insert OID = 3458 ( tan  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_tan _null_ _null_ c ));
DESCR("tan");

/* dotproduct(_complex, _complex) => complex */ 
DATA(insert OID = 3459 ( dotproduct  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "194 194" _null_ _null_ _null_ _null_ complex_dot_product _null_ _null_ c ));
DESCR("dot product");

/* float82complex(float8) => complex */ 
DATA(insert OID = 3460 ( float82complex  PGNSP PGUID 12 1 0 0  f f t f i 1 0 193 f "701" _null_ _null_ _null_ _null_ float82complex _null_ _null_ c ));
DESCR("(internal) type cast from float8 to complex");

/* float42complex(float4) => complex */ 
DATA(insert OID = 3461 ( float42complex  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "700" _null_ _null_ _null_ _null_ float42complex _null_ _null_ c ));
DESCR("(internal) type cast from float4 to complex");

/* int82complex(int8) => complex */ 
DATA(insert OID = 3462 ( int82complex  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "20" _null_ _null_ _null_ _null_ int82complex _null_ _null_ c ));
DESCR("(internal) type cast from int8 to complex");

/* int42complex(int4) => complex */ 
DATA(insert OID = 3463 ( int42complex  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "23" _null_ _null_ _null_ _null_ int42complex _null_ _null_ c ));
DESCR("(internal) type cast from int4 to complex");

/* int22complex(int2) => complex */ 
DATA(insert OID = 3464 ( int22complex  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "21" _null_ _null_ _null_ _null_ int22complex _null_ _null_ c ));
DESCR("(internal) type cast from int2 to complex");

/* power(complex, complex) => complex */ 
DATA(insert OID = 3465 ( power  PGNSP PGUID 12 1 0 0 f f t f i 2 0 193 f "193 193" _null_ _null_ _null_ _null_ complex_pow _null_ _null_ c ));
DESCR("exponentiation (x^y)");

/* sqrt(complex) => complex */ 
DATA(insert OID = 3466 ( sqrt  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_sqrt _null_ _null_ c ));
DESCR("squre root");

/* cbrt(complex) => complex */ 
DATA(insert OID = 3467 ( cbrt  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "193" _null_ _null_ _null_ _null_ complex_cbrt _null_ _null_ c ));
DESCR("cube root");

/* numeric2point("numeric") => complex */ 
DATA(insert OID = 3468 ( numeric2point  PGNSP PGUID 12 1 0 0 f f t f i 1 0 193 f "1700" _null_ _null_ _null_ _null_ numeric2complex _null_ _null_ c ));
