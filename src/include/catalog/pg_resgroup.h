...
typedef enum ResGroupLimitType
{
	...
	RESGROUP_LIMIT_TYPE_IO_WRITE_HARD_LIMIT,
	RESGROUP_LIMIT_TYPE_IO_READ_HARD_LIMIT,
	RESGROUP_LIMIT_TYPE_IO_WIOPS_HARD_LIMIT,
	RESGROUP_LIMIT_TYPE_IO_RIOPS_HARD_LIMIT,
