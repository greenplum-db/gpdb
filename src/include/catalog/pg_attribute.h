...
{ 1255, {"pronargdefaults"},	21, -1, 2, 12, 0, -1, -1, true, 'p', 's', true, false, false, true, 0 }, \
{ 1255, {"prorettype"},			26, -1, 4, 13, 0, -1, -1, true, 'p', 'i', true, false, false, true, 0 }, \
{ 1255, {"proiswin"},			16, -1, 1, 14, 0, -1, -1, true, 'p', 'c', true, false, false, true, 0 }, \
...
{ 1255, {"proargdefaults"},		25, -1, -1, 19, 0, -1, -1, false, 'x', 'i', false, false, false, true, 0 }, \
...
DATA(insert ( 1255 pronargdefaults	21 -1 2  12 0 -1 -1 t p s t f f t 0));
DATA(insert ( 1255 prorettype		26 -1 4  13 0 -1 -1 t p i t f f t 0));
DATA(insert ( 1255 proiswin			16 -1 1  14 0 -1 -1 t p c t f f t 0));
...
DATA(insert ( 1255 proargdefaults	25 -1 -1 19 0 -1 -1 f x i f f f t 0));
