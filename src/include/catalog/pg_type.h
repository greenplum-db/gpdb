...
DATA(insert OID = 2922 (	pg_authid	   PGNSP PGUID -1 f c t \054 1260	0 record_in record_out record_recv record_send - - - d x f 0 -1 0 _null_ _null_ ));
#define PG_AUTHID_RELTYPE_OID 2922
...
DATA(insert OID = 1263 (	_cstring	   PGNSP PGUID -1 f b t \054 0	2275 array_in array_out array_recv array_send - - - i x f 0 -1 0 _null_ _null_ ));
...
DATA(insert OID = 1083 (	time	   PGNSP PGUID 8 t b t \054 0	0 time_in time_out time_recv time_send timetypmodin timetypmodout - d p f 0 -1 0 _null_ _null_ ));
DESCR("hh:mm:ss, ANSI SQL time");
#define TIMEOID			1083

/*  OIDS 1100 - 1199  */
DATA(insert OID = 1114 (	timestamp	   PGNSP PGUID 8 t b t \054 0	0 timestamp_in timestamp_out timestamp_recv timestamp_send timestamptypmodin timestamptypmodout - d p f 0 -1 0 _null_ _null_ ));
DESCR("date and time");
...
DATA(insert OID = 1184 (	timestamptz	   PGNSP PGUID 8 t b t \054 0	0 timestamptz_in timestamptz_out timestamptz_recv timestamptz_send timestamptztypmodin timestamptztypmodout - d p f 0 -1 0 _null_ _null_ ));
