...
DATA(insert OID = 193 (	complex	   PGNSP PGUID 16 f b t \054 0 0	194 complex_in complex_out complex_recv complex_send - - - d p f 0 -1 0 _null_ _null_ ));
DESCR("double-precision floating point complex number, 16-byte storage");
#define COMPLEXOID 193
DATA(insert OID = 194 (	_complex	   PGNSP PGUID -1 f b t \054 0 193 0 array_in array_out array_recv array_send - - - d x f 0 -1 0 _null_ _null_ ));
