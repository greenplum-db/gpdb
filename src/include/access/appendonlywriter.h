...
extern void DeregisterSegnoForCompactionDrop(Oid relid, List *compactedSegmentFileList, bool update_tx_info);
...
extern void UpdateMasterAosegTotalsFromSegments(Relation parentrel,
									...
									int64 modcount_added);
extern void UpdateMasterAosegTotalsFromSegments_DropPhase(Relation parentrel,
												Snapshot appendOnlyMetaDataSnapshot, List *segmentNumList,
												int64 modcount_added);
