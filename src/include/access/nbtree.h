 ...
 * the presence of BT_PIVOT_HEAP_TID_ATTR.  The INDEX_ALT_TID_MASK bit in t_info
 * is always set on BTREE_VERSION 4 pivot tuples, since BTreeTupleIsPivot() 
 * must work reliably on heapkeyspace versions.  BT_PIVOT_HEAP_TID_ATTR can 
