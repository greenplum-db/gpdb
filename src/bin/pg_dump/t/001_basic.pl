...
qr/\Qpg_dumpall: options -g\/--globals-only and --roles-only cannot be used together\E/,
'pg_dumpall: options -g/--globals-only and --roles-only cannot be used together'
);
...
qr/\Qpg_dumpall: options --roles-only and -t\/--tablespaces-only cannot be used together\E/,
'pg_dumpall: options --roles-only and -t/--tablespaces-only cannot be used together'
);
